...
<ul>
                   <li><a href="ManagerVisual.jsp"><font size=3 color="lightgreen">Data Visualization</a></li></font><br><br>
	...
	<form name="f1" method="post" action="ManagerView"  OnSubmit="return validate()">

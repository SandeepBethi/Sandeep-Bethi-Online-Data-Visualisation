...
<ul>
	 ...
	 %>
	 <br><br>
	 <font size="6" face='monotype corsiva'>Input Data Screen</font>
	<form name="f1" method="post" action="Upload" enctype="multipart/form-data" OnSubmit="return validate()">
		...
		<tr>
		  ...
		  <tr><TD align="left"><FONT SIZE="4"  face='monotype corsiva'>Upload Type</TD>
		  <TD><select name="t2">
		...
		<tr>
		  <TD align="left"><FONT SIZE="4"  face='monotype corsiva'>Upload File</FONT></TD>
		  <TD><Input type="file" name="t3"   size="15" ></TD></tr><br>
  		  <tr><td></td>
		  <TD><input type="submit" value="Upload"><br><br>
		  <br>
